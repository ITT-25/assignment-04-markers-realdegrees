...
class Model:
    ...
    def animate(self):
        try:
            ...
            trans = Mat4.from_translation(
                Vec3((self._position[0] - self._win_w / 2), (self._win_h / 2 - self._position[1]), 0)
            )
            ...
            rot = Mat4(
                self._view_matrix[0, 0],
                self._view_matrix[0, 1],
                self._view_matrix[0, 2],
                0,
                self._view_matrix[1, 0],
                self._view_matrix[1, 1],
                self._view_matrix[1, 2],
                0,
                self._view_matrix[2, 0],
                self._view_matrix[2, 1],
                self._view_matrix[2, 2],
                0,
                0,
                0,
                0,
