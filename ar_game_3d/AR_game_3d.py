...
from src.config import INVERSE_MATRIX, WINDOW_WIDTH, WINDOW_HEIGHT, WINDOW_Z, CAMERA_MATRIX, DIST_COEFFS
...
def main():
    ...
    character2_model = Model(
        path=glurak_path, id=5, win_w=WINDOW_WIDTH, win_h=WINDOW_HEIGHT, rot_x=90, rot_y=90, rot_z=0, scaling_factor=0.2
    )
